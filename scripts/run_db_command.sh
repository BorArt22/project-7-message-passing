...
cat ./db/2020-08-15_init-db.sql | kubectl exec -it postgres-554d66564b-sghh5 -- psql -h localhost -U ct_admin -d geoconnections

cat ./db/udaconnect_public_person.sql | kubectl exec -it  postgres-554d66564b-sghh5 -- psql -h localhost -U ct_admin -d geoconnections

cat ./db/udaconnect_public_location.sql | kubectl exec -it  postgres-554d66564b-sghh5 -- psql -h localhost -U ct_admin -d geoconnections